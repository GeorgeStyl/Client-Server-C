/*  server.c  socket server (sms socket server)
*   Georgios Stylianopoulos A.M.: 2022201900219
*/
#include <stdio.h>
#include <stdlib.h>
...
void HandleTCPClient(){
    ...
    //strcpy(reply_buffer,"Your message has been recieved");
